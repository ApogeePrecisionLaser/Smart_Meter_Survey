...
<html>
    ...
    <script type="text/javascript">
        jQuery(function(){
            $("#type_ofBend").autocomplete("typeofbend.do", {
                extraParams: {
                    action1: function() { return "getTypeofbend"}
                }
            });
        });
        ...
        function fillColumns(id)
        {
            ...
            document.getElementById("bendOrder").value=document.getElementById(t1id +(lowerLimit+3)).innerHTML;
            document.getElementById("remark1").value=document.getElementById(t1id +(lowerLimit+4)).innerHTML;
            document.getElementById("latitude").value=document.getElementById(t1id +(lowerLimit+5)).innerHTML;
            document.getElementById("longitude").value=document.getElementById(t1id +(lowerLimit+6)).innerHTML;
                        ...
                        <table>
                               <tr>
                                    <td>
                                        <table align="center">
                                            <tr>
                                                <td align="center" class="header_table" width="90%"><b> Type Of bend</b></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <form name="form1" action="typeofbend.do">
                                            <TABLE BORDER="1" align="center" cellpadding="5" class="content">
                                                <TR>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <TH class="heading">Bend Order&nbsp;</TH>
                                                ...
                                                <c:forEach var="CitystatusBean" items="${requestScope['list']}" varStatus="loopCounter">
                                                    <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                        ...
                                                        <TD id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${CitystatusBean.bendOrder}</TD>
                                        ...
                                        <form  id="form2" action="typeofbend.do" onsubmit="return verify()">
                                            ...
                                            <table BORDER="1" align="center" cellpadding="5" class="content" >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Bend Order</td>
                                                    <td><input type="text" id="bendOrder" name="bendOrder" disabled></td>
                                                </tr>
                                                <tr>
