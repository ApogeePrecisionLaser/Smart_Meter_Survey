...
<html>
    ...
    <script type="text/javascript">
        jQuery(function(){
            $("#searchPipe_type").autocomplete("pipe_type.do", {
                extraParams: {
...
//            });
        ...
        function fillColumns(id) {
            ...
            var pipe_type_id = document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
            document.getElementById("pipe_type_id").value = pipe_type_id;
            document.getElementById("pipe_type").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
        ...
        function verify(){
            ...
            if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                if((document.getElementById("pipe_type").value).trim().length == 0) {
...
//            var url="pipe_type.do?task=showMapWindow&logitude="+y+"&lattitude="+x;
            ...
            <tr>
                <td>
                    <div class="maindiv" id="body">
                        <form name="form" action="pipe_type.do">
                            <table width="100%" align="center" >
                                <tr>
                                    
                                   
                                            <tr>
                                                <td align="center" class="header_table" width="90%"><b>Pipe Type</b></td>
                                            </tr>
                                ...
                                <tr align="center">
                                    <td>
                                        <span class="heading1">Pipe Type</span>
                                        <input class="input" type="text" id="searchPipe_type" name="searchPipe_type" value="${searchPipe_type}" size="15">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        <form name="form1" action="pipe_type.do">
                                            <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                ...
                                                <c:forEach var="pipe_type" items="${requestScope['list']}" varStatus="loopCounter">
                                                    <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                        <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${pipe_type.pipe_type_id}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                        <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${pipe_type.pipe_type}</TD>
                                                        <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${pipe_type.remark}</TD>
                                                    </TR>
                                                </c:forEach>
                                    ...
                                    <div  style="width:990px" >
                                        <form name="form2" action="pipe_type.do" onsubmit="return verify()">
                                            <TABLE BORDER="1" class="content" align="center" cellpadding="5%" width="52%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input class="input" type="hidden" id="pipe_type_id" name="pipe_type_id" value="" >
                                                        <input type="text" id="pipe_type" name="pipe_type" value="" disabled required>
                                                    </td>
                                                </tr>
                                                <tr>
