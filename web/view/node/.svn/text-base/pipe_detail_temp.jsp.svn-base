...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        $("#node_name").autocomplete("PipeDetailTempCont.do", {
            extraParams: {
                action1: function() { return "getNodeName" }
            }
        });
        $("#pipe_type").autocomplete("PipeDetailTempCont.do", {
            extraParams: {
                action1: function() { return "getPipeType" }
            }
        });
        $("#search_node_name").autocomplete("PipeDetailTempCont.do", {
            extraParams: {
                action1: function() { return "getNodeName" }
            }
        });
        $("#search_pipe_type").autocomplete("PipeDetailTempCont.do", {
            extraParams: {
                action1: function() { return "getPipeType" }
            }
        });
    ...
    function displayList(){
        ...
        var url = "PipeDetailTempCont.do?"+queryString+"&search_node_name="+search_node_name;
                ...
                <DIV id="body" class="maindiv" align="center">
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%"><b>Pipe Detail Temp</b></td>
                                    </tr>
                                </table>
                            </td></tr>
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="PipeDetailTempCont.do" onsubmit="return searchCheck()">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="PipeDetailTempCont.do">
                                        ...
                                        <table id="table1" width="800"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="ohLevelBean" items="${requestScope['list']}"  varStatus="loopCounter">
                                                <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}"> <a href="PipeDetailCont.do?task=showNodeData&node_id=${ohLevelBean.node_id}">Update</a></td>
                                                </tr>
                                            </c:forEach>
                                            <tr>
                        ...
                        <tr>
                            <td align="center">
                                <div >
                                    <form name="form2" method="POST" action="PipeDetailTempCont.do" >
                                        <table id="table2"  class="content" border="0"  align="center" width="600">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="input" type="text" id="node_name" name="node_name" value="" size="40" disabled>                              
                                                    <input class="input" type="text" style="display: none" id="pipe_detail_id" name="pipe_detail_id" value="" disabled></td>
                                                <th class="heading1">Pipe Type</th>
                                                <td><input class="input" type="text" id="pipe_type" name="pipe_type" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Head Latitude</th>
                                                <td><input class="input" type="text" id="head_latitude" name="head_latitude" value="" size="40" disabled></td>
                                                <th class="heading1">Head Longitude</th>
                                                <td><input class="input" type="text" id="head_longitude" name="head_longitude" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Tail Latitude</th>
                                                <td><input class="input" type="text" id="tail_latitude" name="tail_latitude" value="" size="40" disabled></td>
                                                <th class="heading1">Tail Longitude</th>
                                                <td><input class="input" type="text" id="tail_longitude" name="tail_longitude" value="" size="40" disabled></td>
                                            </tr>
                                            <tr>
                                                <th class="heading1">Diameter</th>
                                                <td><input class="input" type="text" id="diameter" name="diameter" value="" size="40" disabled></td>
                                                <th class="heading1">Diameter Unit</th>
                                                <td><input class="input" type="text" id="diameter_unit" name="diameter_unit" value="" size="40" disabled></td>

                                            </tr>
                                            <tr>
                                                <th class="heading1">Length</th>
                                                <td><input class="input" type="text" id="length" name="length" value="" size="40" disabled></td>
                                                <th class="heading1">Length Unit</th>
                                                <td><input class="input" type="text" id="length_unit" name="length_unit" value="" size="40" disabled></td>

                                            </tr>
                                            <tr>
                                                <th class="heading1">Pipe Name</th>
                                                <td><input class="input" type="text" id="pipe_name" name="pipe_name" value="" size="40" disabled></td>
