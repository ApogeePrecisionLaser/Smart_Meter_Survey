...
<html>
    <head>
        ...
        jQuery(function()
        {
            $("#searchBend").autocomplete("reason.do", {
                extraParams: {
                    action1: function() { return "getBend" }
                }
            });
        });
        ...
        function fillColumns(id)
        {
            ...
            document.getElementById("bend_id").value = reason_id;
            document.getElementById("bend_name").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
        ...
        {
            document.getElementById("bend_name").disabled=false;
            ...
            if(id == 'new')
            {
                ...
                document.getElementById("bend_name").focus();
            }
        }
        ...
        function verify()
        {
            ...
            if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                if((document.getElementById("bend_name").value).trim().length == 0) {
            ...
            <tr>
                <td>
                    <div class="maindiv" id="body">
                        <form name="form" action="BendCont.do">
                            <table width="100%" align="center" >
                                <tr>
                                    <td>
                                        <table align="center">
                                            <tr>
                                                <td align="center" class="header_table" width="90%"><b>Bend</b></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr align="center">
                                    <td>
                                        <span class="heading1">Bend</span>
                                        <input class="input" type="text" id="searchBend" name="searchBend" value="${searchBend}" size="15">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        <form name="form1" action="BendCont.do">
                                            <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                <TR>
                                                    <th class="heading">S.no.</th>
                                                    <th class="heading">Bend Name</th>
                                                ...
                                                <c:forEach var="reason" items="${requestScope['list']}" varStatus="loopCounter">
                                                    <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                        <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${reason.bend_id}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                        <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${reason.bend_name}</TD>
                                            ...
                                            <input type="hidden"  id="searchBend" name="searchBend" value="${searchBend}">
                                            <input type="hidden" id="noOfRowsTraversed" name="noOfRowsTraversed" value="${noOfRowsTraversed}">
                                        </form>
                                    </div>
                                    <div  style="width:990px" >
                                        <form name="form2" action="BendCont.do" onsubmit="return verify()">
                                            <TABLE BORDER="1" class="content" align="center" cellpadding="5%" width="52%">
                                                ...
                                                <tr>
                                                    <th class="heading1">Bend Name</th>
                                                    <td>
                                                        <input class="input" type="hidden" id="bend_id" name="bend_id" value="" >
                                                        <input type="text" id="bend_name" name="bend_name" value="" disabled required>
                                                    </td>
                                                </tr>
                                                <tr>
