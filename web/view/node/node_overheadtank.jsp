...
<script type="text/javascript" language="javascript">
    jQuery(function(){
        ...
        //            }
        //        });
        $("#overheadtank_name").autocomplete("NodeOverHeadTankCont.do", {
            extraParams: {
                action1: function() { return "getTankName" }
            }
        });
        $("#search_overheadtank_name").autocomplete("NodeOverHeadTankCont.do", {
            extraParams: {
                action1: function() { return "getTankName" }
            }
        });
    ...
    function displayList(){
        ...
        var url = "NodeOverHeadTankCont.do?"+queryString+"&search_node_name="+search_node_name;
            ...
            <td>
                <DIV id="body" class="maindiv" align="center">
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="NodeOverHeadTankCont.do" onsubmit="return searchCheck()">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="NodeOverHeadTankCont.do">
                        ...
                        <tr>
                            <td align="center">
                                <div >
                                    <form name="form2" method="POST" action="NodeOverHeadTankCont.do" >
