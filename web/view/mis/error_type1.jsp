            ...
            <td>
                <DIV id="body" class="maindiv" align="center">
                    <table width="100%" align="center">
                        ...
                        <tr>
                            <td align="center">
                                <form name="form1" method="POST" action="ErrorType1Cont.do">
                                    <DIV class="content_div">
                                        <table id="table1" width="800"  border="1"  align="center" class="content">
                                            <tr >
                                                ...
                                                <td class="heading" style="white-space: normal">Error Value</td>
                                                <td class="heading" style="white-space: normal">Error Type</td>
                                                <td class="heading" style="white-space: normal">Schedule Time</td>
                                                <td class="heading" style="white-space: normal">Actual Time </td>
                                            ...
                                            <c:forEach var="ohLevelBean" items="${requestScope['ohLevelList']}"  varStatus="loopCounter">
                                                <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                    ...
                                                    <td id="t1c${IDGenerator.uniqueID}"   >${ohLevelBean.error_value}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"   >${ohLevelBean.remark}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"   >${ohLevelBean.schedule_time}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"   >${ohLevelBean.actual_time}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"   >${ohLevelBean.status_name}</td>
