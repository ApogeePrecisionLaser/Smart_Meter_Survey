...
<html>
  ...
  <script>
       ...
       function viewChart2(did,oid,ohname){
        ...
        var url = "CanvasJSController111?" + queryString;
     ...
     function goToNewPage()
     {
        ...
        $.ajax({
                    dataType: "json",
                    //                    async: false,
                    url: "DashboardController2?"+queryString,
                    //data:{data: vkp_id},
      ...
      function datashow()
            ...
            {//alert("under data show"); debugger;
                ...
                $.ajax({
                    dataType: "json",
                    //                    async: false,
                    url: "DashboardController2?task=check",
                    //data:{data: vkp_id},
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="DashboardController2">Dashboard</a>
    </div>
