...
//            minDate: -200,
            ...
            window.onload = function () {
                ...
                $.ajax({
                    dataType: "json",
                    async : false,
                    url: "CanvasJSController111?task=getAllDateTime",
                ...
                $.ajax({
                    dataType: "json",
                    async : false,
                    url: "CanvasJSController111?task=getAllOhLevel",
                    //data:{data: vkp_id},
...
//                    dataType: "json",
//                    async : false,
//                    url: "CanvasJSController1?task=getAllSumpwellDateTime",
//                    success: function(response_data) {
...
//                    dataType: "json",
//                    async : false,
//                    url: "CanvasJSController1?task=getAllSumpwellOhLevel",
//                    //data:{data: vkp_id},
//                    success: function(response_data1) {
...
$.ajax({
                    dataType: "json",
                    async : false,
                    url: "CanvasJSController111?task=getAllEnergyMeterDateTime",
                    success: function(response_data) {
                ...
                $.ajax({
                    dataType: "json",
                    async : false,
                    url: "CanvasJSController111?task=getAllEnergyMeterData",
                    //data:{data: vkp_id},
                    success: function(response_data1) {
...
//////////////////////////////////////////////////////////
                ...
                var chart = new CanvasJS.Chart("chartContainer", {
                    zoomEnabled: true,
                    title: {
                        text: "SumpWell & Energy Meter Level"
                    },
//                    axisX: {
...
//                    },
                    ...
                    data: [ {
                            ...
                            showInLegend: true,
                            name: " SumpWell Tank Water Level ",
