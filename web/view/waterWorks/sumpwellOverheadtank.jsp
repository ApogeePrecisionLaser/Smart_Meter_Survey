...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            jQuery(function(){
                $("#sumpwell_name").autocomplete("SumpwellOverheadtankCont.do", {
                    extraParams: {
                        action1: function() { return "getSumpwellName"}
                    }
                });
                $("#overheadtank_name").autocomplete("SumpwellOverheadtankCont.do", {
                    extraParams: {
                        action1: function() { return "getOverheadTankName"}
                    }
                });
                $("#junction_name").autocomplete("SumpwellOverheadtankCont.do", {
                    extraParams: {
                        action1: function() { return "getJunctionImei_no"}
                    }
                });

         $("#search_sumpwell_name").autocomplete("SumpwellOverheadtankCont.do", {
                    extraParams: {
                        action1: function() { return "getSearchSumpwellName"}
                    }
                });
                $("#search_overheadtank_name").autocomplete("SumpwellOverheadtankCont.do", {
                    extraParams: {
                        action1: function() { return "getSearchOverheadTankName"}
                    }
                });
            });
             ...
             function fillColumns(id)
            {
                ...
                document.getElementById("sumpwell_overheadtank_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
                document.getElementById("overheadtank_name").value=document.getElementById(t1id +(lowerLimit+2)).innerHTML;
                document.getElementById("sumpwell_name").value=document.getElementById(t1id +(lowerLimit+3)).innerHTML;
...
//
            ...
            function makeEditable(id) {
                ...
                document.getElementById("sumpwell_name").disabled = false;
                ...
                if(id == 'new') {
                    ...
                    document.getElementById("overheadtank_name").focus();
                }
                if(id == 'edit') {
                ...
                <DIV id="body" class="maindiv" align="center">
                    <table width="100%" align="center">
                        ...
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%"><b>Overhead_Tank Sump_Well</b></td>
                                    </tr>
                                </table>
                            </td></tr>
                         ...
                         <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="SumpwellOverheadtankCont.do" onsubmit="return searchCheck()">
                                        <table align="center" class="heading1" >
                                            <tr><td colspan="11" align="center" style="color: red;" id="searchMessage"></td></tr>
                                            <tr>
                                                <th>Overhead tank</th>
                                                <td><input class="input" type="text" id="search_overheadtank_name" name="search_overheadtank_name" value="${searchPersonName}" size="30" ></td>

                                                <th>Sump well</th>
                                                <td><input class="input" type="text" id="search_sumpwell_name" name="search_sumpwell_name" value="${searchOverheadtankName}" size="30" ></td>
...
<!--                                                <td><input type="button" class="button" id="viewPdf" name="viewPdf" value="PDF File" onclick="getOverheadTank_KeyPersonList()"></td>-->
                        ...
                        <tr align="center">
                            <td >
                                <form name="form1" method="post" action="SumpwellOverheadtankCont.do">
                                    <div class="content_div">
                                        <TABLE BORDER="1" align="center" cellpadding="5%" width="40%" height="100%" class="content">
                                            ...
                                            <th class="heading">Sump Well&nbsp;</th>
                                            <th class="heading">Junction IMEI No.&nbsp;</th>
                                            ...
                                            <c:forEach var="item" items="${requestScope['List']}" varStatus="loopCounter">
                                                ...
                                                <tr>
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${item.sumpwell_overheadtank_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${item.overheadtank_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${item.sumpwell_name}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${item.junction_name}</td>
                        ...
                        <tr align="center">
                            <td>
                                <form name="form2" method="post" action="SumpwellOverheadtankCont.do" onsubmit="return verify()">
                                    <table class="content" border="0" id="table2" align="center" width="20%">
                                        ...
                                        <tr>
                                            <th class="heading1">Overhead Tank</th><td>
                                                <input class="input new_input" type="hidden" id="sumpwell_overheadtank_id" name="sumpwell_overheadtank_id" value="" >
                                                <input class="input new_input" type="text" id="overheadtank_name" name="overheadtank_name" size="60" value=""   disabled maxlength="15">
                                            </td>
                                        </tr>
                                        <tr>

                                            <th class="heading1">Sump Well</th><td>
                                                <input class="input new_input" type="text" id="sumpwell_name" name="sumpwell_name" size="60" value="" disabled></td>
                                        </tr>
                                        <tr>

                                            <th class="heading1">Junction Imei No.</th><td>
                                                <input class="input new_input" type="text" id="junction_name" name="junction_name" size="60" value="" disabled></td>
                                        </tr>
                                        <tr>

                                            <th class="heading1">Remark</th><td>
                                                <input class="input new_input" type="text" id="remark" name="remark" size="60" value="" disabled></td>
                                        </tr>
                                        <tr>
