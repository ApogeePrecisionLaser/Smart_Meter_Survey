    ...
    <head>
        ...
        <script>
            ...
            function multiple() {
                ...
                var last_diffMinutes = $('#last_diffMinutes').val();
                if (last_diffMinutes > 10) {
                    $('#dead').css("background", "red");
                } else {
                    $('#live').css("background", "green");
    ...
    <body onload="multiple()">
        ...
        <div class="container">
            <div class="row">
                ...
                <input type="hidden" id="last_diffMinutes" value="${last_diffMinutes}">



                <table>
                    <tr><th colspan="2">Is Device Live</th></tr>

                    <!--                    <c:choose>
                                            <c:when test="${last_diffMinutes>10}">
                                                <tr><td><div id="live"></div></td><td><div id="dead" style="background:red"></div></td></tr>
                                            </c:when>
                                            <c:otherwise>
                                                <tr><td><div id="live" style="background:green"></div></td><td><div id="dead"></div></td></tr>
                                            </c:otherwise>
                                        </c:choose-->

                    <tr><td><div id="live"></div></td><td><div id="dead"></div></td></tr>


                    <tr><th>Live</div></th><th>Dead</th></tr>
<!--                    <tr style="margin-top:10px"><th>Last Updated Level:</th><td>${last_water_level}</td></tr>
                    <tr><th>Last Updated Date/Time: </th><td>${last_date_time}</td></tr>-->
                </table>
                ...
                <!--<div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                                                     ...
                                                                     <b> Last Updated Level:</b> ${last_water_level}</br>
                                                                     <b>  Last Updated Date/Time:</b> ${last_date_time}
