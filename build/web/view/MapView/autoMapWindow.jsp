...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function openMap(longitude, lattitude)
            {
                ...
                //                lat = $("#lati"+1).val();
                //                lon = $("#longi"+1).val();
                var myCenter=new google.maps.LatLng(23.13,79.89);
                var mapProp = {
                    center:myCenter,
                    zoom:5,
            ...
            function initialize() {
                var mapOptions = {
                    zoom: 17,
                    center: new google.maps.LatLng($("#lati"+1).val(),$("#longi"+1).val()),//(23.15,79.90),
                ...
                // var startIcon = new google.maps.MarkerImage('./images/auto.png');
    ...
    <body>
        ...
        <c:forEach var="surveyCoordinatesBean" items="${requestScope['surveyCoordinatesList']}" varStatus="loopCounter">
            <c:set var="cordinateLength"  value="${loopCounter.count}"></c:set>
            <input type="hidden" id="lati${loopCounter.count}" value="${surveyCoordinatesBean.area_name}">
            <input type="hidden" id="longi${loopCounter.count}" value="${surveyCoordinatesBean.ward_no}">
        </c:forEach>
