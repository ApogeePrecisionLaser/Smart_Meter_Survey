...
//            minDate: -200,
            ...
            window.onload = function () {
                ...
                $.ajax({
                    dataType: "json",
                    async : false,
                    url: "CanvasJSController11?task=getAllDateTime",
                ...
                $.ajax({
                    dataType: "json",
                    async : false,
                    url: "CanvasJSController11?task=getAllOhLevel",
                    //data:{data: vkp_id},
...
//                    dataType: "json",
//                    async : false,
//                    url: "CanvasJSController1?task=getAllEnergyMeterDateTime",
//                    success: function(response_data) {
...
//                    dataType: "json",
//                    async : false,
//                    url: "CanvasJSController1?task=getAllEnergyMeterData",
//                    //data:{data: vkp_id},
//                    success: function(response_data1) {
...
//                }
    ...
    <body>
        ...
        <div id="search_div" style="margin-top:35px; margin-left:60px;">
            <form action="CanvasJSController11" method="post">
         <table>
             <tr>
