...
<script type="text/javascript" language="javascript">
    ...
    function viewoverheadtanklist(){
   document.getElementById("tab1").style.display="none";       
    document.getElementById("tab3").style.display="none";
   document.getElementById("tab2").style.display="block";
}
 function viewSumpwelllist(){
  document.getElementById("tab1").style.display="none";
    document.getElementById("tab3").style.display="block";
   document.getElementById("tab2").style.display="none";
}
 function viewBothlist(){
                    ...
                    <table width="100%" align="center">
                        <tr><td>
                                <table align="center">
                                    ...
                                    <tr> <td align="center" class="header_table" width="100%"><b>View By Category</b></td></tr>
                                    <tr> 
           <td>
               <input type="radio" id="ViewOverHeadTank" name="ViewTank" value="ViewOverHeadTank" onclick="viewoverheadtanklist()">
<label for="ViewOverHeadTank">ViewOverHeadTank</label> 
        
<input type="radio" id="ViewSumpWell" name="ViewTank" value="ViewSumpWell" onclick="viewSumpwelllist()">
<label for="ViewSumpWell">ViewSumpWell</label> 
           
<input type="radio" id="ViewBoth" name="ViewTank" value="ViewBoth" onclick="viewBothlist()" checked>
<label for="ViewBoth">ViewBoth</label>
           </td>
...
<!--                            <td> <div align="center">
                        ...
                        <tr style="display: block" id="tab1">
                            <td align="center">
                                        ...
                                        <table id="table1" width="800"  border="1"  align="center" class="content">
                                            ...
                                            <c:forEach var="ohLevelBean" items="${requestScope['ohLevelList']}"  varStatus="loopCounter">
                                                <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                    ...
                                                    <td></td>
                                                    <td>    
                                                         <input type="button" class="btn"  value ="ViewDashBoard" id="image{loopCounter.count}" onclick="viewDashBoard2('${ohLevelBean.ohLevelId}','${ohLevelBean.waterTreatmentPlantName}','${ohLevelBean.overHeadTankName}','${ohLevelBean.remark}');"/>
                                                    </td>
                        ...
                        <tr style="display: none" id="tab2"> <td align="center">
                                <form name="form1" method="POST" action="DeviceOverheadMapController">
                                    <DIV class="content_div">
                                        <table id="table1" width="800"  border="1"  align="center" class="content">
                                            <tr >
                                            ...
                                            <c:forEach var="ohLevelBean" items="${requestScope['overheadlist']}"  varStatus="loopCounter">
                                                <tr class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}">
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display: none;" onclick="fillColumns(id)">${ohLevelBean.ohLevelId}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit - noOfRowsTraversed + loopCounter.count}</td>
                                                    ...
                                                    <td>    
                                                         <input type="button" class="btn"  value ="ViewDashBoard" id="image{loopCounter.count}" onclick="viewDashBoard1('${ohLevelBean.ohLevelId}','${ohLevelBean.overHeadTankName}','${ohLevelBean.remark}');"/>
                                                    </td>
