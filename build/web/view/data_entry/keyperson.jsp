    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            $(document).ready(function() {
                var check= $("#vehicle_detail").val();
                if(check>0)
                {
                    fillColumnKeyPerson(check);
                }
            });
            jQuery(function(){
                ...
                $("#searchMobileNo").autocomplete("personCount.do", {
                    extraParams: {
            ...
            function makeEditable(id) {               
                ...
                if(id == 'new') {
                    ...
                    setDefaultColordOrgn(document.getElementById("noOfRowsTraversed").value, 24);
            ...
            function fillColumnKeyPerson(id) {
                ...
                document.getElementById("mobile_no1").value = document.getElementById(t1id +(lower+16)).innerHTML;
                document.getElementById("mobile_no2").value = document.getElementById(t1id +(lower+17)).innerHTML;
                document.getElementById("landline_no1").value = document.getElementById(t1id +(lower+18)).innerHTML;
                document.getElementById("landline_no2").value = document.getElementById(t1id +(lower+19)).innerHTML;
                document.getElementById("email_id1").value = document.getElementById(t1id +(lower+20)).innerHTML;
                document.getElementById("email_id2").value = document.getElementById(t1id +(lower+21)).innerHTML;
                document.getElementById("general_image_details_id").value = document.getElementById(t1id +(lower+22)).innerHTML;
            ...
            function displayOrgnList(id){
                ...
                // alert(designation);
                if(id == "viewPdf")
                    queryString = "task1=PRINTRecordList&searchOfficeCode="+searchOfficeCode+"&searchDesignation="+searchDesignation+"&searchKeyPerson="+searchKeyPerson+"&searchEmpCode="+searchEmpCode+"&searchMobileNo="+searchMobileNo;
                else
                    queryString = "task1=PRINTExcelList&searchOfficeCode="+searchOfficeCode+"&searchDesignation="+searchDesignation+"&searchKeyPerson="+searchKeyPerson+"&searchEmpCode="+searchEmpCode+"&searchMobileNo="+searchMobileNo;
                //alert(queryString);
                                    ...
                                    <form name="form1" method="POST" action="personCount.do" >
                                        <table width="100%"  class="heading1" >
                                            <tr><td>
                                                    <table align="center">
                                                        <tr>
                                                            <td align="center" class="header_table" width="90%"><b>Key Person</b></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            ...
                                            <tr align="center">
                                                <td>
                                                    Mobile No<input class="input" type="text" id="searchMobileNo" name="searchMobileNo" value="${searchMobileNo}" size="12">
                                                </td>
                                            </tr>
                                            <tr align="center">
                                                <td>                                                    
                                            ...
                                            <table id="table1"  border="1" align="center" class="content">
                                                ...
                                                <c:forEach var="key" items="${requestScope['keyList']}"  varStatus="loopCounter">
                                                    <tr  class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" >
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)" style="width: 400px" width="400px">${key.organisation_name}</td>
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)">${key.org_office_name}</td>
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)">${key.key_person_name}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)">${key.father_name}</td>
                                                        ...
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)">${key.designation}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)">${key.address_line1}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)" style="display: none">${key.address_line2}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)" style="display: none">${key.address_line3}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" class="" onclick="fillColumnKeyPerson(id)">${key.city_name}</td>
                                    ...
                                    <form name="form2" method="POST" action="personCount.do" encType="multipart/form-data"  onsubmit="return verify()" accept-charset=="UTF-8">
                                        <DIV >
                                            <table id="table2" class="content" border="0" align="center" style="width: 100%" >
                                                ...
                                                <td><input class="input" type="text" id="org_office_name" name="org_office_name"  size="28"  disabled></td>
                                                <th class="heading1" >Employee Id</th>
                                                <td><input class="input" type="text" id="employeeId" name="employeeId" value=""  size="25" disabled></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="input " type="text" id="key_person_name" name="key_person_name" value=""  size="30" disabled></td>
                                                    <th class="heading1" >Father's Name</th>
                                                    <td><input class="input " type="text" id="father_name" name="father_name" value=""  size="25" disabled></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input class="input " type="text" id="designation" name="designation" value=""  size="30" disabled></td>
                                                    <th class="heading1" >Address Line1</th>
                                                    <td><input class="input " type="text" id="address_line1" name="address_line1" value=""  size="25"  disabled></td>
                                                </tr>
                                                <tr>
                                                    <th class="heading1" >Address Line2</th>
                                                    <td><input class="input " type="text" id="address_line2" name="address_line2" value=""   size="25" disabled></td>
                                                    <th class="heading1" >Address Line3</th>
                                                    <td><input class="input " type="text" id="address_line3" name="address_line3" value=""  size="30"  disabled></td>
                                                    <th class="heading1" style="display: none" >State</th>
                                                    <td style="display: none"><input class="input " type="text" id="state_name" name="state_name" value="" size="28"  disabled></td>
                                                    <th class="heading1" >City</th>
                                                    <td><input class="input" type="text" id="city_name" name="city_name"  size="25" value="" disabled></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <input type="hidden"  name="searchOfficeCode" value="${searchOfficeCode}">
                                                <input type="hidden"  name="searchKeyPerson" value="${searchKeyPerson}">
                                                <input type="hidden"  id="vehicle_detail" name="vehicle_detail" value="${vehicle_detail}">
