...
<html>
    ...
    <script type="text/javascript">
        jQuery(function(){
           $("#searchproperties_name").autocomplete("PropertiesController",
           {
            extraParams:
               ...
               $("#properties_name").autocomplete("PropertiesController",
           {
            extraParams: {
                action1: function() { return "getPropertiesName" }
            }
     ...
     function fillColumns(id)
     {
      ...
      document.getElementById("property_details_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
      document.getElementById("properties_name").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
      document.getElementById("value").value=document.getElementById(t1id + (lowerLimit + 3)).innerHTML;
    ...
    <body>
        <table align="center" class="main" cellpadding="0" cellspacing="0" border="1" width="1000px">
            ...
            <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Properties Details</b></td>
                                    </tr>
                                </table>
            ...
            <tr>
                <td>
                    <div class="maindiv" id="body" >
                      <form name="form" action="PropertiesDetailsController">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        <form name="form1" action="PropertiesDetailsController">
                                          <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                ...
                                                <c:forEach var="property_details" items="${requestScope['list']}" varStatus="loopCounter">
                                                  <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${property_details.property_details_id}</td>
                                                    <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${property_details.properties_name}</TD>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${property_details.value}</TD>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${property_details.remark}</TD>
                                                  </TR>
                                                </c:forEach>
                                                              ...
                                                              <c:choose>
                                                                    <c:when test="${showNext eq 'false'}">
                                                                      <input class="button" type='submit' name='buttonAction' value='Next' disabled>
                                                                         ...
                                                                         <form name="form2" action="PropertiesDetailsController" onsubmit="return verify()">
                                                                                ...
                                                                                <tr>
                                                                                   ...
                                                                                   <td><input class="input" type="hidden" id="property_details_id" name="property_details_id" value="" >
                                                                                   <input  type="text" id="properties_name" name="properties_name" value="" disabled></td>
                                                                               </tr>
                                                                               <tr>
                                                                                   <td>value</td>
                                                                                   <td>
                                                                                   <input type="text" id="value" name="value" value="" disabled></td>
                                                                               </tr>
                                                                               <tr>
                                                                                     <td>remark</td>
