...
<html>
    ...
    <script type="text/javascript">
     ...
     function fillColumns(id)
     {
      ...
      document.getElementById("item_name_id").value=document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
    ...
    <body>
        <table align="center" class="main" cellpadding="0" cellspacing="0" border="1" width="1000px">
            ...
            <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="90%"><b>Item Name</b></td>
                                    </tr>
                                </table>
            ...
            <tr>
                 <td>
                     <div class="maindiv" id="body">
                       <form name="form" action="ItemNameController">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        ...
                                        <form name="form1" action="ItemNameController">
                                           <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                ...
                                                <c:forEach var="item_name" items="${requestScope['list']}" varStatus="loopCounter">
                                                  <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                    <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${item_name.item_name_id}</td>
                                                    ...
                                                    <TD id="t1c${IDGenerator.uniqueID}"  onclick="fillColumns(id)">${item_name.remark}</TD>
                                                    <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${item_name.item_code}</TD>
                                                  </TR>
                                                </c:forEach>
                                        ...
                                        <div  style="width:990px" >
                                            <form name="form2" action="ItemNameController" onsubmit="return verify()">
                                                                                ...
                                                                                <tr>
                                                                                   <td>Item Name</td>
                                                                                   <td><input class="input" type="hidden" id="item_name_id" name="item_name_id" value="" >
