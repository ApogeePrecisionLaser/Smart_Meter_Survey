<%--
    Document   : bend
    Created on : Aug 1, 2017, 1:08:13 PM
    Author     : Navitus1
--%>
...
<html>
    ...
    <script type="text/javascript">
        jQuery(function()
        {
            $("#searchValve").autocomplete("reason.do", {
                extraParams: {
                    action1: function() { return "getValve" }
                }
            });
        });
        ...
        function fillColumns(id)
        {
            ...
            var valve_id = document.getElementById(t1id + (lowerLimit + 0)).innerHTML;
            document.getElementById("valve_id").value = valve_id;
            document.getElementById("valve_name").value=document.getElementById(t1id + (lowerLimit + 2)).innerHTML;
            document.getElementById("diameter").value=document.getElementById(t1id + (lowerLimit + 3)).innerHTML;
        ...
        {
            document.getElementById("valve_name").disabled=false;
            ...
            if(id == 'new')
            {
                ...
                document.getElementById("valve_name").focus();
            }
        }
        ...
        function verify()
        {
            ...
            if(document.getElementById("clickedButton").value == 'Save' || document.getElementById("clickedButton").value == 'Save AS New' || document.getElementById("clickedButton").value == 'Update') {
                if((document.getElementById("valve_name").value).trim().length == 0) {
                    //document.getElementById("message").innerHTML = "<td colspan='6' bgcolor='coral'><b>Key Person Name is required...</b></td>";
                    $("#message").html("<td colspan='6' bgcolor='coral'><b>Valve Name is required...</b></td>");
                    document.getElementById("valve_name").focus();
            ...
            <tr>
                <td>
                    <div class="maindiv" id="body">
                        <form name="form" action="ValveCont.do">
                            <table width="100%" align="center" >
                                <tr>
                                    <td>
                                        <table align="center">
                                            <tr>
                                                <td align="center" class="header_table" width="90%"><b>Valve</b></td>
                                            </tr>  
                                        </table>
                                    </td>
                                </tr>
                                <tr align="center">
                                    <td>
                                        <span class="heading1">Valve</span>
                                        <input class="input" type="text" id="searchValve" name="searchValve" value="${searchValve}" size="15">
                            ...
                            <tr>
                                <td align="center">
                                    <div  class="content_div" style="width:990px" >
                                        <form name="form1" action="ValveCont.do">
                                            <TABLE BORDER="1" align="center" cellpadding="5" class="content" >
                                                <TR>
                                                    <th class="heading">S.no.</th>
                                                    <th class="heading">Valve Name</th>
                                                ...
                                                <c:forEach var="reason" items="${requestScope['list']}" varStatus="loopCounter">
                                                    <TR class="${loopCounter.index % 2 == 0 ? 'even': 'odd'}" class="bcolor">
                                                        <td id="t1c${IDGenerator.uniqueID}" style="display:none" onclick="fillColumns(id)">${reason.valve_id}</td>
                                                        <td id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)" align="center">${lowerLimit + loopCounter.count- noOfRowsTraversed}</td>
                                                        <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${reason.valve_name}</TD>
                                                        <TD id="t1c${IDGenerator.uniqueID}" onclick="fillColumns(id)">${reason.diameter}</TD>
                                            ...
                                            <input type="hidden"  id="searchValve" name="searchValve" value="${searchValve}">
                                            <input type="hidden" id="noOfRowsTraversed" name="noOfRowsTraversed" value="${noOfRowsTraversed}">
                                        </form>
                                    </div>
                                    <div  style="width:990px" >
                                        <form name="form2" action="ValveCont.do" onsubmit="return verify()">
                                            <TABLE BORDER="1" class="content" align="center" cellpadding="5%" width="52%">
                                                ...
                                                <tr>
                                                    <th class="heading1">Valve Name</th>
                                                    <td>
                                                        <input class="input" type="hidden" id="valve_id" name="valve_id" value="" >
                                                        <input type="text" id="valve_name" name="valve_name" value="" disabled required>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th class="heading1">Diameter</th>
                                                    <td><input type="text" id="diameter" name="diameter" value="" disabled></td>
                                                </tr>
                                                <tr>
