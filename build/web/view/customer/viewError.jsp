<%-- 
    Document   : viewError
    Created on : Sep 21, 2017, 2:28:38 PM
    Author     : Com7_2
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            jQuery(function(){
                $("#search_key_person").autocomplete("ViewErrorCont.do", {
                    extraParams: {
                        action1: function() { return "getKeyPerson"}
                    }
                });
                $("#search_overhead_tank").autocomplete("ViewErrorCont.do", {
                    extraParams: {
   ...
   function setErrorMsgStatus(id,error_log_msg_id){
   

   var change_command_value = $("#"+id).val();
   //alert(change_command_value+"  ---  "+error_log_msg_id);
        $.ajax({
            url:"ViewErrorCont.do",
            data:"action1=setErrorMsg&error_log_msg_id=" + error_log_msg_id + "&change_command_value=" + change_command_value,
    ...
    function getViewErrorList(){
                ...
                var url = "ViewErrorCont.do?" + queryString;
                ...
                <DIV id="body" class="maindiv" align="center">
                    <table width="100%" align="center">
                        ...
                        <tr><td>
                                <table align="center">
                                    <tr>
                                        <td align="center" class="header_table" width="100%"><b>View Error</b></td>
                                    </tr>
                                </table>
                            </td></tr>
                        ...
                        <tr>
                            <td> <div align="center">
                                    <form name="form0" method="POST" action="ViewErrorCont.do" onsubmit="return searchCheck()">
                        ...
                        <tr align="center">
                            <td >
                                <form name="form1" method="post" action="ViewErrorCont.do">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select id="${lowerLimit - noOfRowsTraversed + loopCounter.count}" name="change_command_value">
                                                            <option value="" ${item.message_status eq ""? 'selected':''}>Select</option>
                                                            <option value="Received" ${item.message_status eq "Received"? 'selected':''}>Received</option>
                                                            <option value="Done" ${item.message_status eq "Done"? 'selected':''}>Done</option>
                                                            
                                                        </select>


                                                    </td>
                                                    <td id="t1c${IDGenerator.uniqueID}"><input type="button" name="" value="SET" onclick="setErrorMsgStatus('${lowerLimit - noOfRowsTraversed + loopCounter.count}','${item.error_log_msg_id}')"/></td>
