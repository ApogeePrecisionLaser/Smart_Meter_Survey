...
public class OHLevelController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, NumberFormatException {
        ...
        List<OHLevel> ohLevelList = ohLevelModel.getAllRecords(lowerLimit, noOfRowsToDisplay, searchWaterTreatmentPlant, searchOverHeadTank,ctx);
        ...
        request.getRequestDispatcher("ohLevelView").forward(request, response);
    }
