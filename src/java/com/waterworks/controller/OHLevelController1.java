...
public class OHLevelController1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<OHLevel> ohLevelList = ohLevelModel.getAllRecords(lowerLimit, noOfRowsToDisplay, searchWaterTreatmentPlant, searchOverHeadTank, overheadtank_id, searchDateFrom, searchDateTo,from_hr,from_min,to_hr,to_min);
