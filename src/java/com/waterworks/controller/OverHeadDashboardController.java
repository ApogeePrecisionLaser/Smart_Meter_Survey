 ...
 * @author Com7_2
 */
public class OverHeadDashboardController extends HttpServlet {
...
//                    waterlevel,water_temperature,water_intensity,datetime,relay_state);
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/view/waterWorks/dashboard_1.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OverHeadDashboardController.class.getName()).log(Level.SEVERE, null, ex);
        }
