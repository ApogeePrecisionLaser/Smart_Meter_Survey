...
import com.mis.model.ErrorLogMsgModel;
 ...
 * @author Com7_2
 */
public class ErrorLogMsgController extends HttpServlet {
    ...
    throws ServletException, IOException {
       ...
       // PrintWriter out = response.getWriter();
         ...
         ServletContext ctx = getServletContext();
          ...
          ErrorLogMsgModel errorViewModel = new ErrorLogMsgModel();
        ...
        try {
           ...
           try {
            ErrorLogMsgModel.setConnection((Connection) DBConnection.getConnectionForUtf(ctx));
        } catch (Exception e) {
            System.out.print("com.mis.controller ErrorLogMsgController DBConnection Error"+e);
        }
               ...
               // PrintWriter pw = response.getWriter();
                ...
                if (JQString != null) {
                 ...
                 if (JQString.equals("setErrorMsg")) {
                      ...
                      errorViewModel.setErrorMsgStatus(id);
                ...
                System.out.println("com.mis.controller ErrorLogMsgController "+e);
            }
             ...
             if (task.equals("generateHSReport"))
           {
              ...
              li=errorViewModel.showData(-1,-1,searchKeyPerson,searchOverheadTank);
           ...
           noOfRowsInTable = errorViewModel.getNoOfRows(searchKeyPerson,searchOverheadTank);//call getNoOfRows() method
           ...
           List list = errorViewModel.showData(lowerLimit,noOfRowsToDisplay,searchKeyPerson,searchOverheadTank);
           ...
           // List list = otkpm.showData();
            ...
            request.getRequestDispatcher("errorlogmsg").forward(request, response);
        } finally {
            //out.close();
        }
    }
