...
import com.node.model.TypeOfBendModel;
...
public class TypeOfBendController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TypeOfBendModel typeOfBendModel = new TypeOfBendModel();
            typeOfBendModel.setConnection(DBConnection.getConnection(ctx));
            ...
            try {
                ...
                if (JQstring != null) {
                    ...
                    if (JQstring.equals("getTypeofbend")) {
                        list = typeOfBendModel.getTypeofbend(q);
                    } 
                    ...
                    typeOfBendModel.closeConnection();
                    return;
                }
            } catch (Exception e) {
            ...
            if (task.equals("getPipeDetailId")) {
                ...
                JSONObject json = typeOfBendModel.getPipeDetail(pipe_detail_id);
                PrintWriter out = response.getWriter();
                out.print(json);
                return;
            }
            if (task.equals("Delete")) {
                typeOfBendModel.deleteRecord(Integer.parseInt(request.getParameter("type_of_bendId")));
                ...
                if (type_of_bend_id == 0 || task.equals("Add All Records")) {
                    ...
                    typeOfBendModel.insertMultipleRecord(typeOfBend, pipe_detail_id);
                    ...
                    typeOfBendModel.updateRecord(typeOfBend, pipe_detail_id);
                }
            }
            try {
            } catch (Exception e) {
            ...
            noOfRowsInTable = typeOfBendModel.getNoOfRows(pipe_detail_id);
            ...
            List<TypeOfBend> list = typeOfBendModel.ShowData(lowerLimit, noOfRowsToDisplay, pipe_detail_id);
            ...
            request.setAttribute("message", typeOfBendModel.getMessage());
            request.setAttribute("msgBgColor", typeOfBendModel.getMsgBgColor());
            request.setAttribute("lowerLimit", lowerLimit);
            request.setAttribute("noOfRowsTraversed", noOfRowsTraversed);
            request.setAttribute("IDGenerator", new UniqueIDGenerator());
            request.getRequestDispatcher("typeofbend").forward(request, response);
        } catch (Exception e) {
