...
import com.node.tableClasses.NodeOverHeadTank;
 ...
 * @author Navitus1
 */
public class NodeOverHeadTankController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String search_node_name = "", search_overheadtank_name = "";
        ...
        try {
            ...
            if (task.equals("Delete")) {
                ...
                NodeOverHeadTank nh = new NodeOverHeadTank();
            ...
            noOfRowsInTable = nodeovertank.getTotalRowsInTable(search_node_name, search_overheadtank_name);                  // get the number of records (rows) in the table.
            ...
            List<NodeOverHeadTank> list = nodeovertank.showAllData(lowerLimit, noOfRowsToDisplay, search_node_name, search_overheadtank_name);
            ...
            request.getRequestDispatcher("node").forward(request, response);
        } catch (Exception e) {
