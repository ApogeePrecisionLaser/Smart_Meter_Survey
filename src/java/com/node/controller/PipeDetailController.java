...
import com.node.model.PipeDetailModel;
 ...
 * @author Shubham
 */
public class PipeDetailController extends HttpServlet {

    List<PipeDetail> list = new ArrayList<PipeDetail>();
    PipeDetail pd1 = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PipeDetailModel pipeDetailModel = new PipeDetailModel();
...
//            }
            ...
            request.getRequestDispatcher("pipe_detail").forward(request, response);
        } catch (Exception e) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PipeDetailController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
