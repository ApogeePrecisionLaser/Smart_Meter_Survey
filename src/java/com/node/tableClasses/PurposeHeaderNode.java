 ...
 * @author Manpreet
 */
public class PurposeHeaderNode {
   ...
   // private String index_no;
    ...
    private ArrayList<PurposeHeaderNode> itemHeader;

     public ArrayList<PurposeHeaderNode> getItemHeader() {
        return itemHeader;
    }

    public void setItemHeader(ArrayList<PurposeHeaderNode> itemHeader) {
        this.itemHeader = itemHeader;
    }

    private ArrayList<PurposeHeaderNode> itemLeaf;

    public ArrayList<PurposeHeaderNode> getItemLeaf() {
        return itemLeaf;
    }

    public void setItemLeaf(ArrayList<PurposeHeaderNode> itemLeaf) {
