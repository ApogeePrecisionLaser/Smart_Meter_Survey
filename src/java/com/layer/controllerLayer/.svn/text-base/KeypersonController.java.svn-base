...
import com.layer.modellLayer.KeypersonModel;

import com.Bean.tableClasses.KeyPerson;
import com.connection.DBConnection.DBConnection;
import com.util.GeneralModel;
...
public class KeypersonController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            keyModel.setDb_username(ctx.getInitParameter("db_username"));
            keyModel.setDb_password(ctx.getInitParameter("db_password"));
        ...
        try {
            ...
            String searchOrganisation = null, searchKeyPerson = null, searchOfficeCode = null, searchEmpCode = null, searchDesignation = null,searchMobileNo=null;
            ...
            searchMobileNo = request.getParameter("searchMobileNo");
            try {
            ...
            if (task1.equals("viewImage")) {
                try {
                   ...
                   if (task1.equals("PRINTRecordList")) {
                        ...
                        list=keyModel.showAll(-1,noOfRowsToDisplay,searchKeyPerson,searchOfficeCode, searchEmpCode,searchDesignation,searchMobileNo);
...
//                 else if (task1 != null && task1.equals("PRINTExcelList")) {
            else if ("PRINTExcelList".equals(task1)) {
           ...
           noOfRowsInTable = keyModel.getNoOfRows(searchOrganisation, searchKeyPerson, searchOfficeCode, searchEmpCode, searchDesignation,searchMobileNo);
            ...
            List<KeyPerson> keyList = keyModel.showData(lowerLimit, noOfRowsToDisplay, searchOrganisation, searchKeyPerson, searchOfficeCode, searchEmpCode, searchDesignation,searchMobileNo);
